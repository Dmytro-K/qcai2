...
- **Dock widget workflow** — Plan, Actions Log, Raw Markdown, Diff Preview, Approvals, and Debug Log tabs, plus goal input, model/reasoning/thinking selectors, run/stop, and dry-run controls.
