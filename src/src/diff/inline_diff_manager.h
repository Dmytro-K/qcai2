...
private:
    ...
    /**
     * Adds the inline preview widget for one hunk into one opened text editor.
     * @param index Hunk index.
     * @param editor Opened text editor instance.
     */
    void attach_hunk_widget(int index, TextEditor::BaseTextEditor *editor);
